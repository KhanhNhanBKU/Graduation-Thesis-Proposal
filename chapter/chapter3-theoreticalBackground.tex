...
% Chém về react-native

\subsection{Firebase}
% Firebase là một nền tảng để phát triển ứng dụng di động và trang web, bao
% gồm các API đơn giản và mạnh mẽ mà không cần backend hay server. Firebase
% hoạt động trên nền tảng đám mây – cloud. Kèm theo đó là hệ thống máy chủ cực
% kỳ mạnh mẽ của Google. Chức năng chính là giúp người dùng lập trình ứng
...
% theo thời gian thực. Dịch vụ này được lưu trữ trực tiếp trên cloud. Trong trường
% hợp thiết bị của bạn ngoại tuyến thì chúng sẽ sử dụng tới bộ nhớ của thiết bị và
% tự động đồng bộ lên server khi thiết bị online.
