...
\begin{table}[H]
  ...
  \begin{tabular}{ |l| p{11cm}|}
    ...
    \hline
        Description & User need to look up a word in the sign language dictionary\\
        \hline
        Actor & User\\
        \hline
        \multirow{2}*{Pre-condition(s)} & For the better result, the device should have internet connection \\
                                        & Previously logged in \\ 
        \hline
        Post-condition(s) & User successfully find out how to sign the word\\
        \hline
        \multirow{2}*{Normal flow}  & 1. The user press dictionary in the navbar\\
        						        & 2. The application directs the user to screen dictionary.\\
        						        & 3. The user input the word and press it on screen.\\
